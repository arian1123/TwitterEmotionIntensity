...
**embedding:** this folder contains Edinburgh word vectors and GloVe word vectors. They are pre-trained and can be downloaded from the links givien in the folder's readme file. Note they needed to be downloaded in order to run extract_features() in main.py.
